...
export class RebookingAndCancellationService {
    ...
    async getRebookingAndCancellationData(originCountry?: any, monthNumber?: any, year?: any,shipperOrgId?:any): Promise<any> {
        let whereObj: any = {};
        return new Promise(async (resolve, reject) => {
            try {
                ...
                let attributes:any;
                attributes = ['month','hawb','mb','shipper_reference','origin','destination','airline','numof_rebookings_shipment','cost_avoidance','comments','year_number','shipment_origin_country', 'shipment_origin', 'shipment_destination', 'shipment_destination_country', 'origin_code',  'destination_code','parent_id']
