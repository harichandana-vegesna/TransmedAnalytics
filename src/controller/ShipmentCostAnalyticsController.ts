    ...
    getRouter(): Router {
        ...
        router.get('/tradelanedetails',this.verifyJwtTokenService.verifyToken, async (req: Request, res: Response, next: NextFunction) => {
            try {
                ...
                let modeOfTransport = req.param('modeOfTransport')
                ...
                dataResult = await this.imShipmentAnalyticsCostService.getShipmentCostAnalysis(originCode,destinationCode,startDate,endDate,accounts,forwarder,shipperOrgId,modeOfTransport)
        ...
        router.get('/tradelaneSummary' ,this.verifyJwtTokenService.verifyToken,async (req: Request, res: Response, next: NextFunction) => {
            try {
                ...
                dataResult = await this.imShipmentAnalyticsCostService.getAggShipmentCostAnalysis(origin,destination,startDate,endDate,accounts,forwarder,shipperOrgId)
                response = new FetchResponse(new ResponseStatus(ResponseCode.SUCCESS, "Retrieved Successfully"), dataResult)
                res.json(response);
            } catch (error) {
                this.logger.log("error", error)
        ...
        router.get('/shipmentcostmonth',this.verifyJwtTokenService.verifyToken, async (req: Request, res: Response, next: NextFunction) => {
            try {
                ...
                dataResult = await this.imShipmentAnalyticsCostService.getAggShipmentCostAnalysisGraph(origin,destination,startDate,endDate,accounts,forwarder,shipperOrgId)
                response = new FetchResponse(new ResponseStatus(ResponseCode.SUCCESS, "Retrieved Successfully"), dataResult)
                res.json(response);
            } catch (error) {
                this.logger.log("error", error)
        ...
        router.get('/allAccounts',this.verifyJwtTokenService.verifyToken, async (req: Request, res: Response, next: NextFunction) => {
            try {
                ...
                let dataResult: any;
                let shipperOrgId = req.param('shipperOrgId')
                dataResult = await this.imShipmentAnalyticsCostService.getAllAccounts(shipperOrgId)
                response = new FetchResponse(new ResponseStatus(ResponseCode.SUCCESS, "Retrieved Successfully"), dataResult)
                res.json(response);
            } catch (error) {
                this.logger.log("error", error)
        ...
        router.get('/allForwarders',this.verifyJwtTokenService.verifyToken, async (req: Request, res: Response, next: NextFunction) => {
            try {
                ...
                let dataResult: any;
                let shipperOrgId = req.param('shipperOrgId')
                dataResult = await this.imShipmentAnalyticsCostService.getAllForwarders(shipperOrgId)
                response = new FetchResponse(new ResponseStatus(ResponseCode.SUCCESS, "Retrieved Successfully"), dataResult)
                res.json(response);
            } catch (error) {
                this.logger.log("error", error)
