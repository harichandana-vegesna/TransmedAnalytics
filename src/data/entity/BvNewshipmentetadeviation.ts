...
export interface BvNewshipmentetadeviationAttributes {
  id: number;
  parent_id?: number;
...
export class BvNewshipmentetadeviation extends Model<BvNewshipmentetadeviationAttributes, BvNewshipmentetadeviationCreationAttributes> implements BvNewshipmentetadeviationAttributes {
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof BvNewshipmentetadeviation {
    BvNewshipmentetadeviation.init({
    id: {
    ...
    sequelize,
    tableName: 'BV_newshipmentetadeviation',
    timestamps: false
  });
  return BvNewshipmentetadeviation;
  }
}
