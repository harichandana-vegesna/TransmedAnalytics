...
export interface BvNewshipmentetadeviationIntransitAttributes {
  id: number;
  parent_id?: number;
...
export class BvNewshipmentetadeviationIntransit extends Model<BvNewshipmentetadeviationIntransitAttributes, BvNewshipmentetadeviationIntransitCreationAttributes> implements BvNewshipmentetadeviationIntransitAttributes {
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof BvNewshipmentetadeviationIntransit {
    BvNewshipmentetadeviationIntransit.init({
    id: {
    ...
    sequelize,
    tableName: 'BV_newshipmentetadeviation_intransit',
    timestamps: false
  });
  return BvNewshipmentetadeviationIntransit;
  }
}
