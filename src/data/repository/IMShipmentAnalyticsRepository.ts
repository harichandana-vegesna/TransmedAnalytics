...
import { BatchtimeUpdate } from "../entity/init-models";
...
export class IMShipmentAnalyticsRepository extends Repository{
    ...
    async update(whereObj: any, updateObj: any, transaction?: Transaction): Promise<ImShipmentAnalytics> {
        this.logger.log("whereObj",whereObj)
        this.logger.log("updateObj",updateObj)

        return await new Promise((resolve, reject) => {
            ImShipmentAnalytics.update(updateObj, { where: whereObj }).then((results: ImShipmentAnalytics | any) => {
    ...
    async getOriginCodes(whereObj: any): Promise<AggCostanalysisShipments[]> {
        ...
        return await new Promise((resolve, reject) => {
            ...
            AggCostanalysisShipments.findAll({
                where: whereObj,attributes:[[Sequelize.fn('distinct', Sequelize.col('origin_code')), 'originCode'],'shipment_origin_country','origin',[Sequelize.fn('lower', Sequelize.col('origin_code')), 'originId']],
    ...
    async getEtaOriginCodes(whereObj: any): Promise<BvShipmentEtaDeviationNodate[]> {
        ...
        return await new Promise((resolve, reject) => {
            ...
            BvShipmentEtaDeviationNodate.findAll({
                where: whereObj,attributes:[[Sequelize.fn('distinct', Sequelize.col('origin_code')), 'originCode'],['origin','origin_name'],['origin_country','origin_country_name'],[Sequelize.fn('lower', Sequelize.col('origin_code')), 'originId']],
    ...
    async getDestinationCodes(whereObj: any): Promise<AggCostanalysisShipments[]> {
        ...
        return await new Promise((resolve, reject) => {
            ...
            AggCostanalysisShipments.findAll({
                where: whereObj,attributes:[[Sequelize.fn('distinct', Sequelize.col('destination_code')), 'destinationCode'],'shipment_destination','shipment_destination_country',[Sequelize.fn('lower', Sequelize.col('destination_code')), 'destinationId']],
            }).then((get: AggCostanalysisShipments[]) => {
                resolve(get);
            }).catch((error: any) => {
                this.logger.error(error);
    ...
    async getDeliveriedOnTimeRecords(whereObj: any ,transaction?: Transaction): Promise<BatchtimeUpdate[]> {
        return await new Promise((resolve, reject) => {
            BatchtimeUpdate.findAll({where: whereObj ,attributes:['hawb']})
            .then((get: BatchtimeUpdate[]) => {
                resolve(get);
            }).catch((error: any) => {
                this.logger.error(error);
                reject(error);
    ...
    async getMawbs(whereObj: any ,transaction?: Transaction): Promise<ImShipmentAnalytics[]> {
        return await new Promise((resolve, reject) => {
            ImShipmentAnalytics.findAll({ where: whereObj , attributes:[[Sequelize.fn('distinct', Sequelize.col('mst_reference_id')), 'mst_reference_id']]})
            .then((get: ImShipmentAnalytics[]) => {
                resolve(get);
            }).catch((error: any) => {
                this.logger.error(error);
